            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="black_bg">
                        <div class="row">
                            <div class="col-md-7 ">
                                <form class="main_form" method="POST" action="/save" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    <div class="row">
                                        <div class="col-md-12 ">
                                        ...
                                        <div class="col-md-12">
                                            <input required class="contactus" placeholder="Phone number" type="number" min="0" name="number">
                                        </div>
                                        <div class="col-md-12">
