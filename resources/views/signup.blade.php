        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <h2>Sign Up</h2>
                        <span>Explore more features and enjoy our site by creating your account.
                            <br>
                ...
                <div class="col-sm-12">
                    <div class="black_bg">
                        <div class="row container">
                            <div class="col-md-12">
                                <form class="main_form" method="POST" action="{{ route('register.custom') }}" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    <div class="row">
                                        <div class="col-md-12">
                                            @if ($errors->has('name'))
                                            ...
                                            @endif
                                            <input required class="contactus" placeholder="Name" type="text" name="name" autofocus>
                                        </div>
                                        <div class="col-md-12">
                                            @if ($errors->has('email'))
                                        ...
                                        <div class="col-sm-12">
                                            <button type="submit" name="signin" class="send_btn">Sign Up</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
