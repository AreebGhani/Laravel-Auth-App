        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <h2>About Pcoint</h2>
                        <span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores eos sequi excepturi natus libero deleniti. Commodi quia ullam natus! Omnis nostrum optio eos, ipsum animi quo perferendis adipisci! Veritatis, nam.</span>
                    </div>
                </div>
            </div>
            <div class="row">
